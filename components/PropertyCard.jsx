  ...
  return (
    <div class="rounded-xl shadow-md relative">
      ...
      <div class="p-4">
        ...
        <h3 class="absolute top-[10px] right-[10px] bg-white px-4 py-2 rounded-lg text-emerald-500 font-bold text-right md:text-center lg:text-right">
          ${getRatesDisplay()}
        </h3>
        ...
        <div class="flex flex-col lg:flex-row justify-between mb-4">
          <div class="flex align-middle gap-2 mb-4 lg:mb-0">
            <FaMapMarker className="text-violet-700 mt-1" />
